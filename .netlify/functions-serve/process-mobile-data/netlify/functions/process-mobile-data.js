...
// netlify/functions/process-mobile-data.js
var process_mobile_data_exports = {};
__export(process_mobile_data_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(process_mobile_data_exports);
...
// netlify/functions/process-mobile-data.js
var API_BASE_URL = "https://starlinksapi.app/api/v1/shipments/get-list";
var API_KEY = process.env.STARLINKS_API_KEY || "399c08024f1f5206d6eef361c1203394d3be9763";
...
var handler = async (event, context) => {
  ...
  try {
    ...
    const results = await Promise.all(mobileNumbers.map(async (item) => {
      ...
      else if (cleanMobile.length === 10 && cleanMobile.startsWith("0")) cleanMobile = "966" + cleanMobile.substring(1);
      else if (cleanMobile.startsWith("966")) {
      }
      try {
        const response = await axios_default.get(API_BASE_URL, {
          params: {
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=process-mobile-data.js.map
